...
class LoanCreateTest extends TestCase
{
    ...
    public function testLoadFromJson_Tmpl4(){
        ...
        $this->assertEquals([LSETUP::LOAN_AMT=>12000.00, LSETUP::DISCOUNT=>500.00, LSETUP::UNDERWRITING=>0.00, LSETUP::LOAN_RATE=>12.0212, LSETUP::LRATE_TYPE_C=>LSETUP\LSETUP_LRATE_TYPE_C::ANNUAL],
            $loan->get(LOAN::LSETUP)->get(LSETUP::LOAN_AMT, LSETUP::DISCOUNT, LSETUP::UNDERWRITING, LSETUP::LOAN_RATE, LSETUP::LRATE_TYPE_C));

        $this->assertEquals([LSETUP::LOAN_TERM=>36, LSETUP::CONTRACT_DATE=>1430956800, LSETUP::FIRST_PAY_DATE=>1431043200, LSETUP::AMT_DOWN=>0.00, LSETUP::RESERVE=>5.00],
            $loan->get(LOAN::LSETUP)->get(LSETUP::LOAN_TERM, LSETUP::CONTRACT_DATE, LSETUP::FIRST_PAY_DATE, LSETUP::AMT_DOWN, LSETUP::RESERVE));

        $this->assertEquals([LSETUP::SALES_PRICE=>12000, LSETUP::GAP=>1120.0, LSETUP::WARRANTY=>2500, LSETUP::DEALER_PROFIT=>1000, LSETUP::TAXES=>125.25],
            $loan->get(LOAN::LSETUP)->get(LSETUP::SALES_PRICE, LSETUP::GAP, LSETUP::WARRANTY, LSETUP::DEALER_PROFIT, LSETUP::TAXES));

        $this->assertEquals([LSETUP::CREDIT_LIMIT=>15500, LSETUP::DISCOUNT_SPLIT=>1, LSETUP::PAY_FREQ_C=>LSETUP\LSETUP_PAY_FREQ_C::MONTHLY, LSETUP::CALC_TYPE_C=>LSETUP\LSETUP_CALC_TYPE_C::SIMPLE_INTEREST],
            $loan->get(LOAN::LSETUP)->get(LSETUP::CREDIT_LIMIT, LSETUP::DISCOUNT_SPLIT, LSETUP::PAY_FREQ_C, LSETUP::CALC_TYPE_C));
        ...
        $this->assertEquals([
            ...
            $loan->get(LOAN::LSETUP)->get(LSETUP::DAYS_IN_YEAR_C, LSETUP::INTEREST_APP_C, LSETUP::BEG_END_C, LSETUP::FIRST_PER_DAYS_C, LSETUP::FIRST_DAY_INT_C, LSETUP::DISCOUNT_CALC_C,LSETUP::DIY_ALT_C,
