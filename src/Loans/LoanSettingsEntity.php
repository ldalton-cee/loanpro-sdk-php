...
class LoanSettingsEntity extends BaseEntity
{
    ...
    protected static $fields = [
        ...
        LSETTINGS::CARD_FEE_TYPE_C          => FieldValidator::COLLECTION,
        LSETTINGS::CREDIT_STATUS_C          => FieldValidator::COLLECTION,
        LSETTINGS::CREDIT_BUREAU_C          => FieldValidator::COLLECTION,
        LSETTINGS::ECOA_CODE_C              => FieldValidator::COLLECTION,
        LSETTINGS::CO_BUYER_ECOA_CODE_C     => FieldValidator::COLLECTION,
        LSETTINGS::EBILLING_C               => FieldValidator::COLLECTION,
        LSETTINGS::REPORTING_TYPE_C         => FieldValidator::COLLECTION,
