...
class LSETTINGS{
    ...
    const SOURCE_COMPANY_ID      = 'sourceCompany';
    const EBILLING__C            = 'eBilling';
    const ECOA_CODE__C           = 'ECOACode';
    const CO_BUYER_ECOA_CODE__C  = 'coBuyerECOACode';
    ...
    const STOPLGHT_MANUALLY_SET  = 'isStoplightManuallySet';
